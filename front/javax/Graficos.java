...
public class Graficos extends JPanel {
    ...
    private int altura = 160; // altura do grafico
    private int espaco = 60; // espaco entre valores
    ...
    public void paintComponent(Graphics g) {
        ...
        int tamanhoLinha = rotulos.size() * espaco + 40; // comprimento da linha horizontal
